  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50">
      <div className="container mx-auto px-6 lg:px-16 flex items-center justify-between h-20">
        <a href="#" className="flex items-center" aria-label="MARLA Agency — Inicio">
          <img src={marlaLogo} alt="MARLA Agency" className="h-40 w-auto object-contain" />
        </a>
        ...
        {/* Mobile toggle */}
        <button onClick={() => setOpen(!open)} className="md:hidden text-foreground" aria-label="Abrir menú">
